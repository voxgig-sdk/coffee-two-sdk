...
// CoffeeTwo SDK clienttrack feature
...
class CoffeeTwoClienttrackFeature extends CoffeeTwoBaseFeature
{
    ...
    public function PostConstruct(CoffeeTwoContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'CoffeeTwo-SDK';
