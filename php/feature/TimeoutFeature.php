...
class CoffeeTwoTimeoutFeature extends CoffeeTwoBaseFeature
{
    ...
    private function _with_timeout(CoffeeTwoContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(CoffeeTwoContext $_ctx, float $ms): void
    {
        $client = $this->client;
