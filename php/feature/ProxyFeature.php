...
class CoffeeTwoProxyFeature extends CoffeeTwoBaseFeature
{
    ...
    public function init(CoffeeTwoContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (CoffeeTwoContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
