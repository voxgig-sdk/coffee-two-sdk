...
class CoffeeTwoTestRunner
{
    ...
    {
        $live = self::getenv('COFFEE_TWO_TEST_LIVE');
        $override = self::getenv('COFFEE_TWO_TEST_OVERRIDE');
        ...
        $explain = self::getenv('COFFEE_TWO_TEST_EXPLAIN');
...
class_alias('CoffeeTwoTestRunner', 'Runner');
class_alias('CoffeeTwoHelpers', 'Helpers');
