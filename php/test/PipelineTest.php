...
{
    private static function utility(): CoffeeTwoUtility
    {
        return new CoffeeTwoUtility();
    }
    ...
    private static function ctx(array $over = []): CoffeeTwoContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new CoffeeTwoContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new CoffeeTwoOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof CoffeeTwoError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new CoffeeTwoOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = CoffeeTwoMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new CoffeeTwoOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = CoffeeTwoMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new CoffeeTwoOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = CoffeeTwoMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new CoffeeTwoSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = CoffeeTwoMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new CoffeeTwoResponse([]),
            'result' => new CoffeeTwoResult([]),
        ]);
        [, $err] = CoffeeTwoMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new CoffeeTwoSpec([]),
            'response' => null,
            'result' => new CoffeeTwoResult([]),
        ]);
        [, $err] = CoffeeTwoMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new CoffeeTwoSpec(['step' => 's']),
            'response' => new CoffeeTwoResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new CoffeeTwoResult([]),
        ]);
        [, $err] = CoffeeTwoMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new CoffeeTwoSpec(['step' => 's']),
            'response' => new CoffeeTwoResponse(self::resp(200, ['v' => 1])),
            'result' => new CoffeeTwoResult([]),
        ]);
        [, $err] = CoffeeTwoMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new CoffeeTwoSpec(['step' => 's']),
            'response' => new CoffeeTwoResponse(self::resp(200, ['v' => 2])),
            'result' => new CoffeeTwoResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        CoffeeTwoMakeResponse::call($ctx);
    ...
    {
        $preset = new CoffeeTwoResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new CoffeeTwoSpec([]),
            'response' => new CoffeeTwoResponse([]),
            'result' => new CoffeeTwoResult([]),
        ...
        [$got, $err] = CoffeeTwoMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new CoffeeTwoResult([])]);
        [, $err] = CoffeeTwoMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new CoffeeTwoSpec([]), 'result' => null]);
        [, $err] = CoffeeTwoMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new CoffeeTwoSpec(['step' => 's']),
            'result' => new CoffeeTwoResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new CoffeeTwoOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = CoffeeTwoMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new CoffeeTwoSpec(['step' => 's']),
            'result' => new CoffeeTwoResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new CoffeeTwoOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = CoffeeTwoMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new CoffeeTwoResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new CoffeeTwoSpec([]),
            'result' => new CoffeeTwoResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = CoffeeTwoMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = CoffeeTwoMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new CoffeeTwoError('boom', 'boom');
        $utility->fetcher = function (CoffeeTwoContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new CoffeeTwoSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = CoffeeTwoMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (CoffeeTwoContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = CoffeeTwoMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(CoffeeTwoResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (CoffeeTwoContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new CoffeeTwoSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = CoffeeTwoMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new CoffeeTwoResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new CoffeeTwoSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = CoffeeTwoMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = CoffeeTwoMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = CoffeeTwoMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new CoffeeTwoResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, CoffeeTwoDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new CoffeeTwoResult(['ok' => false])]);
        $this->expectException(CoffeeTwoError::class);
        CoffeeTwoDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new CoffeeTwoResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', CoffeeTwoMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        CoffeeTwoMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new CoffeeTwoBaseFeature();
        $b = new CoffeeTwoBaseFeature();
        CoffeeTwoFeatureAdd::call($ctx, $a);
        CoffeeTwoFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): CoffeeTwoBaseFeature
    {
        $f = new CoffeeTwoBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        CoffeeTwoFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): CoffeeTwoContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new CoffeeTwoSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = CoffeeTwoPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new CoffeeTwoResponse(['headers' => null]),
            'result' => new CoffeeTwoResult([]),
        ]);
        CoffeeTwoResultHeaders::call($ctx);
