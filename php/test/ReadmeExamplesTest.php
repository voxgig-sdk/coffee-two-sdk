...
// CoffeeTwo SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (CoffeeTwoSDK::test)
...
{
    private const SDK_CLASS = 'CoffeeTwoSDK';
    ...
    private const SDK_BASE = 'coffeetwo_sdk';
