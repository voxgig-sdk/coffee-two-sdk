...
{
    public function test_direct_load_coffee(): void
    {
        $setup = coffee_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-coffee", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
