...
// CoffeeTwo SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = CoffeeTwoOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(CoffeeTwoOmni::structfix($now, Struct::undef()))
                        !== json_encode(CoffeeTwoOmni::structfix($val, Struct::undef()))) {
