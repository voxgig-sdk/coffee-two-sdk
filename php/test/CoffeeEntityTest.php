...
class CoffeeEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set COFFEE_TWO_TEST_COFFEE_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function coffee_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("COFFEE_TWO_TEST_COFFEE_ENTID");
    ...
    if ($env["COFFEE_TWO_TEST_LIVE"] === "TRUE") {
