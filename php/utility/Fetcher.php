...
// CoffeeTwo SDK utility: fetcher

class CoffeeTwoFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; CoffeeTwoSDK/1.0)';
    ...
    public static function call(CoffeeTwoContext $ctx, string $fullurl, array $fetchdef): array
    {
