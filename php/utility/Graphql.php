...
class CoffeeTwoGraphql
{
    ...
    // equivalent.
    public static function body(CoffeeTwoContext $ctx): mixed
    {
    ...
    public static function errors(CoffeeTwoContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
