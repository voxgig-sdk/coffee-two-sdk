...
class CoffeeTwoNetsimFeature extends CoffeeTwoBaseFeature
{
    ...
    private function _simulate(CoffeeTwoContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(CoffeeTwoContext $ctx, array $applied): void
    {
        $client = $this->client;
