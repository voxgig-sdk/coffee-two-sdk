...
// CoffeeTwo SDK ratelimit feature
...
class CoffeeTwoRatelimitFeature extends CoffeeTwoBaseFeature
{
    ...
    private function _acquire(CoffeeTwoContext $ctx): void
    {
    ...
    private function _track(CoffeeTwoContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
