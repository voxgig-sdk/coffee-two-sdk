...
// CoffeeTwo SDK streaming feature
...
class CoffeeTwoStreamingFeature extends CoffeeTwoBaseFeature
{
    ...
    private function _iterate(CoffeeTwoResult $result): \Generator
    {
    ...
    private function _streamable(CoffeeTwoContext $ctx): bool
    {
