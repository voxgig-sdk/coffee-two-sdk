...
// CoffeeTwo SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class CoffeeTwoTestFeature extends CoffeeTwoBaseFeature
{
    ...
    public function init(CoffeeTwoContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (CoffeeTwoContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = CoffeeTwoParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (CoffeeTwoContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(CoffeeTwoContext $ctx, $op, $args): array
    {
