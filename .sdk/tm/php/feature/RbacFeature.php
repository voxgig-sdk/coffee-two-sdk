...
class CoffeeTwoRbacFeature extends CoffeeTwoBaseFeature
{
    ...
    private function _required(CoffeeTwoContext $ctx): ?string
    {
    ...
    private function _reject(CoffeeTwoContext $ctx, string $required): void
    {
    ...
    private function _track(CoffeeTwoContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
