...
class CoffeeTwoCacheFeature extends CoffeeTwoBaseFeature
{
    ...
    private function _through(CoffeeTwoContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
