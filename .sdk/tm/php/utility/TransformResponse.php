...
// CoffeeTwo SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class CoffeeTwoTransformResponse
{
    public static function call(CoffeeTwoContext $ctx): mixed
    {
        ...
        $transform = CoffeeTwoHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
