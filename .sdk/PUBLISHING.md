...
|---|---|---|
| `ts/` | @voxgig-sdk/coffee-two-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/coffee-two-sdk \
      --repository voxgig-sdk/coffee-two-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/coffee-two-sdk` shows it, and
`npm trust revoke @voxgig-sdk/coffee-two-sdk --id=<id>` removes it.
