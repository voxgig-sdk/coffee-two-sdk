...
from coffeetwo_sdk.utility import register

# Load features
from coffeetwo_sdk.feature.base_feature import CoffeeTwoBaseFeature
from coffeetwo_sdk.features import _has_feature, _make_feature
...
class CoffeeTwoSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = CoffeeTwoUtility()
        self._utility = utility

        from coffeetwo_sdk.config import shared_config
    ...
    def get_utility(self):
        return CoffeeTwoUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("CoffeeTwoSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Coffee(self, data=None) -> "CoffeeEntity":
        ...
        from coffeetwo_sdk.entity.coffee_entity import CoffeeEntity
