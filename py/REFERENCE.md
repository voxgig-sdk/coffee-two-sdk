# CoffeeTwo Python SDK Reference

Complete API reference for the CoffeeTwo Python SDK.
...
#### `CoffeeTwoSDK.test(testopts=None, sdkopts=None)`
...
| --- | --- | --- | --- |
| `file` | `str` | Yes | URL of the random coffee image |
