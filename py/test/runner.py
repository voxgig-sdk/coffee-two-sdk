...
class CoffeeTwoTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = CoffeeTwoTestRunner.getenv("COFFEETWO_TEST_LIVE")
        override = CoffeeTwoTestRunner.getenv("COFFEETWO_TEST_OVERRIDE")
        ...
        explain = CoffeeTwoTestRunner.getenv("COFFEETWO_TEST_EXPLAIN")
        if explain is not None and explain != "":
            m["COFFEETWO_TEST_EXPLAIN"] = explain
