# CoffeeTwo SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions CoffeeTwoSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both CoffeeTwoSDK(...) and CoffeeTwoSDK.test(...) become
#      CoffeeTwoSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "coffeetwo_sdk"
_SDK_CLASS = "CoffeeTwoSDK"
