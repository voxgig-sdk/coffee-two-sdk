...
function envOverride(m) {
    if ('TRUE' === process.env.COFFEE_TWO_TEST_LIVE ||
        'TRUE' === process.env.COFFEE_TWO_TEST_OVERRIDE) {
    ...
    m.COFFEE_TWO_TEST_EXPLAIN = process.env.COFFEE_TWO_TEST_EXPLAIN || m.COFFEE_TWO_TEST_EXPLAIN;
    return m;
}
