...
(0, node_test_1.describe)('CoffeeDirect', async () => {
    // Per-test live pacing. Delay is read from sdk-test-control.json's
    // `test.live.delayMs`; only sleeps when COFFEE_TWO_TEST_LIVE=TRUE.
    (0, node_test_1.afterEach)((0, utility_1.liveDelay)('COFFEE_TWO_TEST_LIVE'));
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.CoffeeTwoSDK({
    ...
    (0, node_test_1.test)('direct-load-coffee', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-coffee', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.CoffeeTwoSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {}));
        let idmap = env['COFFEE_TWO_TEST_COFFEE_ENTID'];
    ...
    const client = new __1.CoffeeTwoSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=CoffeeDirect.test.js.map