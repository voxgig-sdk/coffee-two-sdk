...
func registerSDKWords(r *eng.Registry, client *sdk.CoffeeTwoSDK) {
...
func runOp(client *sdk.CoffeeTwoSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
