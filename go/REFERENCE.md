# CoffeeTwo Golang SDK Reference

Complete API reference for the CoffeeTwo Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *CoffeeTwoSDK`
...
#### `Coffee(data map[string]any) CoffeeTwoEntity`
