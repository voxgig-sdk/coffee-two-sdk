...
describe("CoffeeDirect", function()
  it("should direct-load-coffee", function()
    local setup = coffee_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-coffee", setup.live and "live" or "unit")
