...
describe("CoffeeEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set COFFEETWO_TEST_COFFEE_ENTID JSON to run live")
      return
    end
...
function coffee_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("COFFEETWO_TEST_COFFEE_ENTID")
