...
type Args struct {
	Entity string         `json:"entity" jsonschema:"coffee"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.CoffeeTwoSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "coffee-two_list",
		Description: "List records from CoffeeTwo. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "coffee-two_load",
		Description: "Load a single record from CoffeeTwo. " +
...
func runOp(client *sdk.CoffeeTwoSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.CoffeeTwoSDK, name string) (sdk.CoffeeTwoEntity, error) {
